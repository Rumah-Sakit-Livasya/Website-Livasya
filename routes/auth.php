...
Route::middleware(['guest', 'throttle:auth'])->group(function () {
    ...
    // Route::get('/bukan-login', [AuthenticatedSessionController::class, 'create'])
    //     ->name('login');
    // Route::post('/bukan-login', [AuthenticatedSessionController::class, 'store']);
...
Route::middleware('auth')->group(function () {
    Route::get('verify-account', EmailVerificationPromptController::class)
