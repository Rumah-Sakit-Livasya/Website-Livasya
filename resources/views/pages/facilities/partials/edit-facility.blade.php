<div class="modal fade" id="edit-fasilitas" tabindex="-1" role="dialog" aria-hidden="true">
    <div class="modal-dialog modal-lg" role="document">
        <div class="modal-content">
            <form autocomplete="off" novalidate method="post" enctype="multipart/form-data" id="update-facility-form">
                @method('put')
                @csrf
                ...
                <div class="modal-body">
                    <div class="form-group">
                        <label class="form-label" for="edit-unggulan">
                            Unggulan
                        </label>
                        <select class="form-control w-100" id="edit-unggulan" name="unggulan">
                    ...
                    <div class="form-group">
                        <label for="edit-name">Nama Fasilitas</label>
                    ...
                    <div class="form-group">
                        <label for="edit-body" class="form-label">Isi Fasilitas</label>
