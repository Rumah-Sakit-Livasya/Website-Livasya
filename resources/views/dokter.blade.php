                ...
                <div class="col-lg-3" style="border-radius: 20px;">
                    <a href="{{ asset('storage/' . $dokter->poster) }}" data-fancybox="gallery"
                        ...
                        <div class="card-img-top img overflow-hidden img-thumbnail shadow"
                            style="z-index: 0; background-image: url({{ asset('/storage/' . $dokter->poster) }}); background-size: cover; height: 500px; background-position: center top; border-radius: 20px;">
                        </div>
                    </a>
                </div>
                <div class="col-lg-3" style="border-radius: 20px;">
                    <a href="{{ asset('storage/' . $dokter->jadwal) }}" data-fancybox="gallery"
                        data-caption="{{ $dokter->name }}">
                        <div class="card-img-top img overflow-hidden img-thumbnail shadow"
                            style="z-index: 0; background-image: url({{ asset('/storage/' . $dokter->jadwal) }}); background-size: cover; height: 500px; background-position: center top; border-radius: 20px;">
                        </div>
                    </a>
                </div>
                </p>
