                    ...
                    <div class="col-lg-12 col-m col-12 mx-auto">
                        ...
                        <div id="personal" class="section">
                            ...
                            <div class="row gap-y">
                                ...
                                <div class="col-12 col-lg-6 mb-3">
                                    <div class="form-group">
                                        <label for="create-social-security" class="fw-normal">BPJS Ketenagakerjaan</label>
                        ...
                        <div id="work" class="section pt-0">
                            <h4 class="mt-5 fw-bold">Pengalaman kerja</h4>
                            <hr class="w-100 my-4">
                            <div id="workForm">
                                <div class="row gap-y" id="workForm0">
                                    <div class="col-12 col-lg-6 mt-3">
                                        <div class="form-group">
                                            <label for="create-work-name" class="fw-normal">Nama Perusahaan</label>
                                    ...
                                    <div class="col-12 col-lg-6 mt-3">
                                        <div class="form-group">
                                            <label for="create-work-position" class="fw-normal">Posisi Terakhir</label>
                                    ...
                                    <div class="col-12 col-lg-12 mt-3">
                                        <div class="form-group">
                                            <label for="create-work-address" class="fw-normal">Alamat Perusahaan</label>
                                            <textarea name="work_address[]" id="create-work-address" class="form-control" placeholder="" rows="3"></textarea>
                                        </div>
                                    </div>
                                    <div class="col-12 col-lg-6 mt-3">
                                        <div class="form-group">
                                            <label for="create-work-start" class="fw-normal">Mulai tanggal</label>
                                    ...
                                    <div class="col-12 col-lg-6 mt-3">
                                        <div class="form-group">
                                            <label for="create-work-end" class="fw-normal">Tanggal Berakhir</label>
                                    ...
                                    <div class="col-12 col-lg-6 mt-3">
                                        <div class="form-group">
                                            <label for="create-work-start-salary" class="fw-normal">Gaji awal</label>
                                    ...
                                    <div class="col-12 col-lg-6 mt-3">
                                        <div class="form-group">
                                            <label for="create-work-latest-salary" class="fw-normal">Gaji Terbaru</label>
                                            <div class="input-group">
                                                <div class="input-group-prepend">
                                                    <span class="input-group-text">Rp</span>
                                                </div>
                                    ...
                                    <div class="col-12 col-lg-12 mt-3">
                                        <div class="form-group">
                                            <label for="create-work-reason" class="fw-normal">Alasan untuk pergi</label>
                                    ...
                                    <div class="col-12 col-lg-12 mt-3">
                                        <div class="form-group">
                                            <label for="create-work-contact-yes" class="fw-normal">Jika ya, harap berikan
                                                nama, nomor kontak. Jika tidak, jelaskan alasannya</label>
                                    ...
                                    <div class="col-12 col-lg-12 mt-3">
                                        <div class="form-group">
                                            <label for="create-work-achievement" class="fw-normal">Prestasi</label>
                            ...
                            <div class="row gap-y">
                                ...
                                <div class="col-12 col-lg-12 mt-3">
                                    <label for="create-declare-family-member" class="fw-normal">
                                        ...
                                        karyawan, siapa yang bekerja di perusahaan ini? (Ya/Tidak)
                                        <br>
                                ...
                                <div class="col-12 col-lg-12 mt-3">
                                    <label for="create-declare-suspended" class="fw-normal">
                                        ...
                                        oleh perusahaan tempat Anda bekerja sebelumnya? (Ya/Tidak)
                                        <br>
                                ...
                                <div class="col-12 col-lg-12 mt-3">
                                    <label for="create-declare-criminal" class="fw-normal">3. Apakah Anda pernah dihukum
                                        ...
                                        dibatalkan atau dibatalkan? (Ya / Tidak)
                                        <br>
                                ...
                                <div class="col-12 col-lg-12 mt-3">
                                    <label for="create-declare-lvs" class="fw-normal">4. Apakah anda pernah
                                        melamar/bekerja di
                                        RUMAH SAKIT LIVASYA? pilih salah satu (Ya/Tidak)</label>
                                    <div class="form-group">
                                ...
                                <div class="col-12 col-lg-12 mt-3">
                                    <label for="create-declare-politic" class="fw-normal">5. Apakah Anda saat ini memegang
                                        posisi di partai politik atau calon pejabat politik mana pun?
                                        <br>
    ...
    <script>
        ...
        $('#create-button').on('click', function() {
            $.ajax({
                ...
                error: function(xhr) {
                    alert('Formulir tidak lengkap, Anda harus mengisi semua formulir yang diperlukan!');
                    // $.unblockUI();
                    // $('html, body').animate({
