...
class SecurityHeadersMiddleware
{
    ...
    public function handle(Request $request, Closure $next): Response
    {
        ...
        $csp = implode('; ', [
            ...
            "script-src 'self' 'unsafe-inline' 'unsafe-eval' 'nonce-{$nonce}' https: http: blob: cdn.jsdelivr.net http://localhost:5173",
            // Style: Must allow unsafe-inline for JS libraries (SweetAlert, etc) to inject styles.
            "style-src 'self' 'unsafe-inline' https: http: blob: fonts.googleapis.com cdn.jsdelivr.net http://localhost:5173",
